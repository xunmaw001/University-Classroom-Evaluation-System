            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">普通老师登记</li>
                    </ol>
                </div>
            </div>
        </div>
                            ...
                            <!-- 本表所有字段 -->
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="putonglaoshiIdNumber" name="putonglaoshiIdNumber" class="form-control"
                                               v-model="ruleForm.putonglaoshiIdNumber" readonly>
                                    </div>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <%--<input style="width: 450px" id="laoshiPingfen" name="laoshiPingfen" class="form-control"--%>
                                               <%--v-model="ruleForm.laoshiPingfen" readonly>--%>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="putonglaoshiEmail" name="putonglaoshiEmail" class="form-control"
                                               v-model="ruleForm.putonglaoshiEmail" readonly>
                                    </div>
    ...
    var vm = new Vue({
        ...
        beforeCreate: function () {
            ...
            if (id != null && id != "" && id != "null") {
                $.ajax({
                    type: "GET",
                    url: baseUrl + "putonglaoshi/info/" + id,
