    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">编辑普通老师</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">编辑普通老师</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">普通老师信息</h3>
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                    ...
                                    <div class="form-group col-md-6 putonglaoshiUuidNumberDiv">
                                        <label>普通老师工号</label>
                                        <input style="width: 450px" id="putonglaoshiUuidNumber" name="putonglaoshiUuidNumber" class="form-control"
                                               placeholder="普通老师工号">
                                    </div>
                                    <div class="form-group col-md-6 putonglaoshiNameDiv">
                                        <label>普通老师姓名</label>
                                        <input style="width: 450px" id="putonglaoshiName" name="putonglaoshiName" class="form-control"
                                               placeholder="普通老师姓名">
                                    </div>
                                    <div class="form-group col-md-6 putonglaoshiPhoneDiv">
                                        <label>普通老师手机号</label>
                                        <input style="width: 450px" id="putonglaoshiPhone" name="putonglaoshiPhone" class="form-control"
                                               onchange="putonglaoshiPhoneChickValue(this)"  placeholder="普通老师手机号">
                                    </div>
                                    <div class="form-group col-md-6 putonglaoshiIdNumberDiv">
                                        <label>普通老师身份证号</label>
                                        <input style="width: 450px" id="putonglaoshiIdNumber" name="putonglaoshiIdNumber" class="form-control"
                                               onchange="putonglaoshiIdNumberChickValue(this)"  placeholder="普通老师身份证号">
                                    </div>
                                    <div class="form-group col-md-6 putonglaoshiPhotoDiv">
                                        <label>普通老师头像</label>
                                        <img id="putonglaoshiPhotoImg" src="" width="100" height="100">
                                        <input name="file" type="file" id="putonglaoshiPhotoupload"
                                               class="form-control-file">
                                        <input name="putonglaoshiPhoto" id="putonglaoshiPhoto-input" type="hidden">
                                    </div>
                                    ...
                                    <div class="form-group col-md-6 kemuTypesDiv">
                                        <label>所教科目</label>
                                        <select style="width: 450px" id="kemuTypesSelect" name="kemuTypes" class="form-control">
                                        </select>
                                    </div>
                                    <div class="form-group col-md-6 laoshiPingfenDiv">
                                        <label>老师评分</label>
                                        <div id="laoshiPingfenDiv1"></div>
                                        <%--<input type="hidden" style="width: 450px" id="gongkaikeTingkePingfen" name="gongkaikeTingkePingfen" class="form-control">--%>

                                        <input type="hidden" style="width: 450px" id="laoshiPingfen" name="laoshiPingfen" placeholder="老师评分">
                                    </div>

                                    <div class="form-group col-md-6 putonglaoshiEmailDiv">
                                        <label>普通老师电子邮箱</label>
                                        <input style="width: 450px" id="putonglaoshiEmail" name="putonglaoshiEmail" class="form-control"
                                               placeholder="普通老师电子邮箱">
                                    </div>
...
<script>
    ...
    function upload() {
        ...
        <!-- 当前表的文件上传 -->
        $('#putonglaoshiPhotoupload').fileupload({
            url: baseUrl + 'file/upload',
            headers: {token: window.sessionStorage.getItem("token")},
            dataType: 'json',
            done: function (e, data) {
                var photoUrl= baseUrl + 'file/download?fileName=' + data.result.file;
                document.getElementById('putonglaoshiPhotoImg').setAttribute('src',photoUrl);
                document.getElementById('putonglaoshiPhoto-input').setAttribute('value',photoUrl);
            }
        });
    ...
    function submit() {
        if (validform() == true && compare() == true) {
            ...
            httpJson("putonglaoshi/" + urlParam, "POST", data, (res) => {
                if(res.code == 0){
                    window.sessionStorage.removeItem('addputonglaoshi');
    ...
    //数字检查
        <!-- 当前表的数字检查 -->
        function putonglaoshiPhoneChickValue(e){
        ...
        function putonglaoshiIdNumberChickValue(e){
            var this_val = e.value || 0;
    ...
    function validform() {
        return $("#addOrUpdateForm").validate({
            rules: {
                username: "required",
                password: "required",
                putonglaoshiUuidNumber: "required",
                putonglaoshiName: "required",
                putonglaoshiPhone: "required",
                putonglaoshiIdNumber: "required",
                putonglaoshiPhoto: "required",
                sexTypes: "required",
                kemuTypes: "required",
                laoshiPingfen: "required",
                putonglaoshiEmail: "required",
            },
            messages: {
                username: "账户不能为空",
                password: "密码不能为空",
                putonglaoshiUuidNumber: "普通老师工号不能为空",
                putonglaoshiName: "普通老师姓名不能为空",
                putonglaoshiPhone: "普通老师手机号不能为空",
                putonglaoshiIdNumber: "普通老师身份证号不能为空",
                putonglaoshiPhoto: "普通老师头像不能为空",
                sexTypes: "性别不能为空",
                kemuTypes: "所教科目不能为空",
                laoshiPingfen: "老师评分不能为空",
                putonglaoshiEmail: "普通老师电子邮箱不能为空",
            }
        }).form();
    }
    ...
    // 获取当前详情
    function getDetails() {
        var addputonglaoshi = window.sessionStorage.getItem("addputonglaoshi");
        if (addputonglaoshi != null && addputonglaoshi != "" && addputonglaoshi != "null") {
            //注册表单验证
            $(validform());
            $("#putonglaoshiUuidNumber").val(new Date().getTime()+Math.ceil(Math.random()*10));//设置唯一号
            ...
            window.sessionStorage.removeItem('updateId');
            http("putonglaoshi/info/" + updateId, "GET", {}, (res) => {
                if(res.code == 0)
                {
                    ruleForm = res.data
                    // 是/否下拉框回显
                    ...
                    if(window.sessionStorage.getItem("role")== '普通老师' || window.sessionStorage.getItem("role")== '督导老师'){
                        ...
                        layui.use(['jquery', 'rate'], function () {
                            ...
                            rate.render({
                                elem: '#laoshiPingfenDiv1'
                                ,value: ruleForm.laoshiPingfen //初始值
                                ,text: true //开启文本
                                ,readonly: true //不可修改
                                ,choose:function(value){
                                    $("#laoshiPingfen").val(value);
